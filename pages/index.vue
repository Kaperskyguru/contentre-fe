  ...
  <main>
    <div id="hero" class="h-full">
      <div class="relative bg-teal-100">
        ...
        <div class="relative container px-4 mx-auto">
          <img
            class="absolute bottom-0 left-0 h-12 xl:h-20 absolute-circle"
            src="~/assets/img/circle.svg"
            alt=""
          />
          <img
            class="absolute bottom-0 right-0 h-12 xl:h-20 absolute-dotbr"
        ...
        >
          ...
          >
            <div class="my-2 font-extrabold tracking-wide">
              Comprehensive article Insights
            </div>
            <div class="text-sm leading-8">
              It is a long established fact that a reader will be distracted by
              the readable content of a page when looking at its layout. The
              point of using Lorem Ipsu
            </div>
          </div>
    ...
    <div>
      ...
      >
        <div class="relative container px-4 mx-auto">
          <img
            class="absolute bottom-0 left-0 h-12 xl:h-20 absolute-dotbottom"
            src="~/assets/img/dot.svg"
            alt=""
          />
          <img
            class="absolute top-0 right-0 h-12 xl:h-20 absolute-dottop"
            src="~/assets/img/dot.svg"
            alt=""
          />
          <div class="lg:flex items-center">
            <div class="max-w-screen-xl mx-auto">
              <div class="pt-10">
                <h3 class="font-black text-xl text-center leading-8">
                  Manage your articles with
                  <br />Contentr for free in less than 10 <br />
                  minutes
                </h3>
              </div>
              <div
          ...
          >
            ...
            >
              <h1
                ...
                "
              >
                Get real-time Insights to
                <br class="hidden lg:inline-block text-black" />manage your
                article flow.
              </h1>
                    ...
                    >
                      ...
                      <div class="bg-gray-200 rounded-lg px-4 py-4 ml-2">
                        <span class="inline-flex"
                          >Market research and statistics for 2021 in the
          ...
          >
            ...
            >
              ...
              >
                ...
                <br class="hidden lg:inline-block text-black" />yourself easily.
              </h1>
              <p class="mb-4 leading-8">
                It is a long established fact that a reader will be distracted
                by the readable content of a page when looking at its layout.
          ...
          >
            ...
            >
              ...
              >
                ...
                <br class="hidden lg:inline-block text-black" />from your
                content tab.
              </h1>
              <p class="mb-4 leading-8">
                It is a long established fact that a reader will be distracted
              ...
              <div class="w-full md:w-1/2 xl:w-1/2 px-4">
                <div class="space-y-4">
                  <h3 class="font-semibold text-dark text-3xl mb-4 block">
                    Ditch spreadsheets. Manage your articles with Contentr in
                    minutes.
                  </h3>
                </div>
              </div>
        ...
        <div class="bg-transparent border-t-2">
          <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col">
            <p class="text-white text-sm text-center">
              Copyright ® 2022 Contentr All rights Reserved
            </p>
          </div>
        </div>
      </footer>
